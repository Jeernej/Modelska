...
#        rN=np.append(rN,np.sqrt(x[i]**2+y[i]**2+z[i]**2))      # radij okrog izhodišča
        rN=np.append(rN,np.sqrt(x[i]**2+y[i]**2))      # radij okrog osi
    else :
        xZ=np.append(xZ,x[i])
        yZ=np.append(yZ,y[i])
        zZ=np.append(zZ,z[i])      
#        rZ=np.append(rZ,np.sqrt(x[i]**2+y[i]**2+z[i]**2))      # radij okrog izhodišča
        rZ=np.append(rZ,np.sqrt(x[i]**2+y[i]**2))      # radij okrog osi
...
#        rkr=np.append(rkr,np.sqrt(x[i]**2+y[i]**2+z[i]**2))      # radij okrog izhodišča
        rkr=np.append(rkr,np.sqrt(x[i]**2+y[i]**2))      # radij okrog osi
...
#        rvaljOS=np.append(rvaljOS,np.sqrt(x[i]**2+y[i]**2+z[i]**2))      # radij okrog izhodišča
        rvaljOS=np.append(rvaljOS,np.sqrt(x[i]**2+y[i]**2))      # radij okrog osi
...
#        rvaljPravok=np.append(rvaljPravok,np.sqrt(x[i]**2+y[i]**2+z[i]**2))      # radij okrog izhodišča
        rvaljPravok=np.append(rvaljPravok,np.sqrt(x[i]**2+y[i]**2))      # radij okrog osi
