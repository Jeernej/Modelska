...
for i in range(0,N):
    ...
    while L<=10:
        ...
        if L>=0.1 and L1==0:  # za debeilno 0.1 sipalne dolžine
            ...
            KOT_pobegli1=np.append(KOT_pobegli1,np.cos(psi)) #kot izstopa prehoda
        ...
        if L>=0.5 and L2==0:  # za debeilno 0.1 sipalne dolžine
            ...
            KOT_pobegli2=np.append(KOT_pobegli2,np.cos(psi)) #kot izstopa prehoda
        ...
        if L>=1 and L3==0:  # za debeilno 0.1 sipalne dolžine
            ...
            KOT_pobegli3=np.append(KOT_pobegli3,np.cos(psi)) #kot izstopa prehoda
        ...
        if L>=2 and L4==0:  # za debeilno 0.1 sipalne dolžine
            ...
            KOT_pobegli4=np.append(KOT_pobegli4,np.cos(psi)) #kot izstopa prehoda
        ...
        if L>=5 and L5==0:  # za debeilno 0.1 sipalne dolžine
            ...
            KOT_pobegli5=np.append(KOT_pobegli5,np.cos(psi)) #kot izstopa prehoda
...
#        print('sipanje')
        ...
        if L<=0 :
            ...
            if L1==0:
                ...
                odbiti1=odbiti1+1
                KOT_odbiti1=np.append(KOT_odbiti1,np.cos(psi))
...
#                print('odbit')
            if L2==0:
                ...
                odbiti2=odbiti2+1
                KOT_odbiti2=np.append(KOT_odbiti2,np.cos(psi))
...
#                print('odbit')
            if L3==0:
                ...
                odbiti3=odbiti3+1
                KOT_odbiti3=np.append(KOT_odbiti3,np.cos(psi))
...
#                print('odbit')
            if L4==0:
                ...
                odbiti4=odbiti4+1
                KOT_odbiti4=np.append(KOT_odbiti4,np.cos(psi))
                sipanje_odbiti4=np.append(sipanje_odbiti4,sipanje)
                L4=1
            if L5==0:
            
                odbiti5=odbiti5+1
                KOT_odbiti5=np.append(KOT_odbiti5,np.cos(psi))
                sipanje_odbiti5=np.append(sipanje_odbiti5,sipanje)
                L5=1#                print('odbit')
            if L6==0:
            
                odbiti6=odbiti6+1
                KOT_odbiti6=np.append(KOT_odbiti6,np.cos(psi))
    ...
    if L>=10 and L6==0:  # za debeilno 0.1 sipalne dolžine
        ...
        KOT_pobegli6=np.append(KOT_pobegli6,np.cos(psi)) #kot izstopa prehoda
...
#
HKOT_odbiti1, xKOT_odbiti1, binEdge_KOT_odbiti1, LKOT_odbiti1=Hdata(KOT_odbiti1)  
HKOT_odbiti2, xKOT_odbiti2, binEdge_KOT_odbiti2, LKOT_odbiti2=Hdata(KOT_odbiti2)  
HKOT_odbiti3, xKOT_odbiti3, binEdge_KOT_odbiti3, LKOT_odbiti3=Hdata(KOT_odbiti3)  
HKOT_odbiti4, xKOT_odbiti4, binEdge_KOT_odbiti4, LKOT_odbiti4=Hdata(KOT_odbiti4)  
HKOT_odbiti5, xKOT_odbiti5, binEdge_KOT_odbiti5, LKOT_odbiti5=Hdata(KOT_odbiti5)  
HKOT_odbiti6, xKOT_odbiti6, binEdge_KOT_odbiti6, LKOT_odbiti6=Hdata(KOT_odbiti6)  
...
plt.step(xKOT_pobegli3,HKOT_pobegli3,'b',alpha = 0.5,label=r'pobegli $\mu=1$')#+'{:.{}f}'.format(momentTelo[m-1], 5 ))
...
plt.yscale('log')
plt.legend(loc='best')
plt.title('Porazdelitev po vrednostih izstopnih kotov \n za pobege iz reflektorja; računano za N='+str(N)+' nevtronov')#+'(N='+str(N)+',M='+str(M)+')')
...
plt.step(xKOT_odbiti3,HKOT_odbiti3,'b',alpha = 0.5,label=r'odbiti $\mu=1$')#+'{:.{}f}'.format(momentTelo[m-1], 5 ))
plt.step(xKOT_odbiti4,HKOT_odbiti4,'m',alpha = 0.5,label=r'odbiti $\mu=2$')#+'{:.{}f}'.format(momentTelo[m-1], 5 ))
plt.step(xKOT_odbiti5,HKOT_odbiti5,'c',alpha = 0.5,label=r'odbiti $\mu=5$')#+'{:.{}f}'.format(momentTelo[m-1], 5 ))
plt.step(xKOT_odbiti6,HKOT_odbiti6,'y',alpha = 0.5,label=r'odbiti $\mu=10$')#+'{:.{}f}'.format(momentTelo[m-1], 5 ))
plt.xlabel(r'$\cos(\theta)$')
#plt.ylabel(r'$dP/dl$')
plt.ylabel('n')
#plt.xlim(0,6)
plt.yscale('log')
plt.legend(loc='best')
plt.title('Porazdelitev po vrednostih izstopnih kotov \n za odboje iz reflektorja; računano za N='+str(N)+' nevtronov')#+'(N='+str(N)+',M='+str(M)+')')
