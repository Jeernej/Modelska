...
c=0
for i in [8,16,32]: # števila polov
    ali2=a(SIG_256,i)
    zk2=z(ali2)
    zk2_in=z_in(zk2)
...
#c=0
#for i in [8,20,40]: # števila polov
#    ali2=a(SIG2_256,i)
#    zk2=z(ali2)
#    zk2_in=z_in(zk2)
#    plt.scatter(zk2.real,zk2.imag, color=barva[c],alpha = 0.95,  marker='x', label='p={}'.format(i))
...
#    alin2=ak_abs(zk2,ali2)
#    
#    napoved=S_napov(ali2,SIG2) ### brez normiranja
##    napoved=S_napov(alin2,SIG)
#    N=len(napoved)
#    F50=plt.subplot(2,2, 1 ) 
#    plt.plot(T[LS//2:LS],napoved[LS//2:LS],color=barva[c],alpha = 0.6,label='p={}'.format(i))
#    F50=plt.subplot(2,2, 2 ) 
#    plt.plot(T[LS//2:LS],SIG2[LS//2:LS]-napoved[LS//2:LS],color=barva[c],ls='-',alpha = 0.75, label='p={}'.format(i))#+'{:.{}f}'.format(SHfi, 3 ))
#    c=c+1
#
#F50=plt.subplot(2,2, 1 ) 
#plt.title('Linearna napoved (brez normiranja)',fontsize=16)   
#plt.plot(T[LS//2:LS],SIG2[LS//2:LS],color='k',ls='-',alpha = 0.4, label=val[1])#+'{:.{}f}'.format(SHfi, 3 ))
#plt.yscale('log')
#plt.xlabel('t',fontsize=16)   
#plt.ylabel('Amplituda',fontsize=16)   
#plt.xlim([0.5,1])
...
#c=0
#for i in [10,14,56]: # števila polov
#    ali2=a(SIG3_lin_302,i)
#    zk2=z(ali2)
#    zk2_in=z_in(zk2)
#    plt.scatter(zk2.real,zk2.imag, color=barva[c],alpha = 0.95,  marker='x', label='p={}'.format(i))
##    plt.scatter(zk2_in.real,zk2_in.imag, color=barva[c],alpha = 0.5,   marker='s',label='p={}'.format(i))
...
#    alin2=ak_abs(zk2,ali2)
#    
#    napoved=S_napov(ali2,SIG3_lin) ### brez normiranja
##    napoved=S_napov(alin2,SIG)
#    N=len(napoved)
#    F50=plt.subplot(1,2, 1 ) 
#    plt.plot(T3[LS3//2:LS3],napoved[LS3//2:LS3],color=barva[c],alpha = 0.6,label='p={}'.format(i))
#    F50=plt.subplot(1,2, 2 ) 
#    plt.plot(T3[LS3//2:LS3],SIG3_lin[LS3//2:LS3]-napoved[LS3//2:LS3],color=barva[c],ls='-',alpha = 0.75, label='p={}'.format(i))#+'{:.{}f}'.format(SHfi, 3 ))
#    c=c+1
#
#F50=plt.subplot(1,2, 1 ) 
#plt.title('Linearna napoved (brez normiranja)',fontsize=16)   
#plt.plot(T3[LS3//2:LS3],SIG3_lin[LS3//2:LS3],color='k',ls='-',alpha = 0.4, label=val[2])#+'{:.{}f}'.format(SHfi, 3 ))
##plt.yscale('log')
#plt.xlabel('t',fontsize=16)   
#plt.ylabel('Amplituda',fontsize=16)   
#plt.xlim([LS3//2,LS3])
...
#
#F150=plt.figure(150)
#F150=plt.subplot(1,2, 1 ) 
#plt.title('Izmerjen signal '+val[3]+' ;  N='+str(LS4),fontsize=16)
#plt.plot(T4,SIG4,color='k',ls='-',alpha = 0.95)#+'{:.{}f}'.format(SHfi, 3 ))
#plt.ylabel('Amplituda' ,fontsize=16)  
#plt.xlabel(' t ' ,fontsize=16)
#plt.xlim([0,LS4])
##plt.yscale('log')
#
#
#F150=plt.subplot(1,2, 2) 
#plt.title('Poli za vzorec  '+val[3]+' ;  N='+str(LS4),fontsize=16)
#c=0
#for i in [8,16,32]: # števila polov
#    ali2=a(SIG4_256,i)
#    zk2=z(ali2)
...
#    alin2=ak_abs(zk2,ali2)
#    
#    napoved=S_napov(ali2,SIG4) ### brez normiranja
##    napoved=S_napov(alin2,SIG)
#    N=len(napoved)
#    F50=plt.subplot(2,2, 1 ) 
#    plt.plot(T4[LS4//2:LS4],napoved[LS4//2:LS4],color=barva[c],alpha = 0.6,label='p={}'.format(i))
#    F50=plt.subplot(2,2, 2 ) 
#    plt.plot(T4[LS4//2:LS4],SIG4[LS4//2:LS4]-napoved[LS4//2:LS4],color=barva[c],ls='-',alpha = 0.75, label='p={}'.format(i))#+'{:.{}f}'.format(SHfi, 3 ))
#    c=c+1
#
#F50=plt.subplot(2,2, 1 ) 
#plt.title('Linearna napoved (brez normiranja)',fontsize=16)   
#plt.plot(T4[LS4//2:LS4],SIG4[LS4//2:LS4],color='k',ls='-',alpha = 0.4, label=val[3])#+'{:.{}f}'.format(SHfi, 3 ))
##plt.yscale('log')
#plt.xlabel('t',fontsize=16)   
#plt.ylabel('Amplituda',fontsize=16)   
#plt.xlim([LS4//2,LS4])
...
#F150=plt.figure(150)
#F150=plt.subplot(1,2, 1 ) 
#plt.title('Izmerjen signal '+val[4]+' ;  N='+str(LS5),fontsize=16)
#plt.plot(T5,SIG5,color='k',ls='-',alpha = 0.95)#+'{:.{}f}'.format(SHfi, 3 ))
#plt.ylabel('Amplituda' ,fontsize=16)  
#plt.xlabel(' t ' ,fontsize=16)
#plt.xlim([0,LS5])
##plt.yscale('log')
...
#
#F150=plt.subplot(1,2, 2) 
#plt.title('Poli za vzorec  '+val[4]+' ;  N='+str(LS5),fontsize=16)
#c=0
#for i in [16,32,64,68]: # števila polov
#    ali2=a(SIG5_256,i)
#    zk2=z(ali2)
#    zk2_in=z_in(zk2)
#    plt.scatter(zk2.real,zk2.imag, color=barva[c],alpha = 0.95,  marker='x', label='p={}'.format(i))
...
#    alin2=ak_abs(zk2,ali2)
#    
#    napoved=S_napov(ali2,SIG5) ### brez normiranja
##    napoved=S_napov(alin2,SIG)
#    N=len(napoved)
#    F50=plt.subplot(2,2, 1 ) 
#    plt.plot(T5[LS5//2:LS5],napoved[LS5//2:LS5],color=barva[c],alpha = 0.6,label='p={}'.format(i))
#    F50=plt.subplot(2,2, 2 ) 
#    plt.plot(T5[LS5//2:LS5],SIG5[LS5//2:LS5]-napoved[LS5//2:LS5],color=barva[c],ls='-',alpha = 0.75, label='p={}'.format(i))#+'{:.{}f}'.format(SHfi, 3 ))
#    c=c+1
#
#F50=plt.subplot(2,2, 1 ) 
#plt.title('Linearna napoved (brez normiranja)',fontsize=16)   
#plt.plot(T5[LS5//2:LS5],SIG5[LS5//2:LS5],color='k',ls='-',alpha = 0.4, label=val[4])#+'{:.{}f}'.format(SHfi, 3 ))
##plt.yscale('log')
#plt.xlabel('t',fontsize=16)   
#plt.ylabel('Amplituda',fontsize=16)   
#plt.xlim([LS5//2,LS5])
...
#F150=plt.figure(150)
#F150=plt.subplot(1,2, 1 ) 
#plt.title('Izmerjen signal '+val[5]+' ;  N='+str(LS6),fontsize=16)
#plt.plot(T6,SIG6,color='k',ls='-',alpha = 0.95)#+'{:.{}f}'.format(SHfi, 3 ))
#plt.ylabel('Amplituda' ,fontsize=16)  
#plt.xlabel(' t ' ,fontsize=16)
#plt.xlim([0,LS6])
##plt.yscale('log')
...
#
#F150=plt.subplot(1,2, 2) 
#plt.title('Poli za vzorec  '+val[5]+' ;  N='+str(LS6),fontsize=16)
#c=0
#for i in [32,88,100]: # števila polov
#    ali2=a(SIG6_256,i)
#    zk2=z(ali2)
#    zk2_in=z_in(zk2)
#    plt.scatter(zk2.real,zk2.imag, color=barva[c],alpha = 0.95,  marker='x', label='p={}'.format(i))
...
#    alin2=ak_abs(zk2,ali2)
#    
#    napoved=S_napov(ali2,SIG6) ### brez normiranja
##    napoved=S_napov(alin2,SIG)
#    N=len(napoved)
#    F50=plt.subplot(2,2, 1 ) 
#    plt.plot(T6[LS6//2:LS6],napoved[LS6//2:LS6],color=barva[c],alpha = 0.6,label='p={}'.format(i))
#    F50=plt.subplot(2,2, 2 ) 
#    plt.plot(T6[LS6//2:LS6],SIG6[LS6//2:LS6]-napoved[LS6//2:LS6],color=barva[c],ls='-',alpha = 0.75, label='p={}'.format(i))#+'{:.{}f}'.format(SHfi, 3 ))
#    c=c+1
#
#F50=plt.subplot(2,2, 1 ) 
#plt.title('Linearna napoved (brez normiranja)',fontsize=16)   
#plt.plot(T6[LS6//2:LS6],SIG6[LS6//2:LS6],color='k',ls='-',alpha = 0.4, label=val[5])#+'{:.{}f}'.format(SHfi, 3 ))
##plt.yscale('log')
#plt.xlabel('t',fontsize=16)   
#plt.ylabel('Amplituda',fontsize=16)   
#plt.xlim([LS6//2,LS6])
