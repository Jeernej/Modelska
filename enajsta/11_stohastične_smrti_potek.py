...
#    N0=25
    ...
    while  Nt[i]>0 :
        ...
        dN=np.random.poisson(lam=1.0*Nt[i]*dt, size=None)
        
        Nt=np.append(Nt, Nt[i]-dN)
    ...
    F50=plt.figure(50)
    plt.suptitle(r'Umiranje populacije računano z različnimi časovnimi koraki; $N_0=250$,  $\beta=1$',fontsize=16)
