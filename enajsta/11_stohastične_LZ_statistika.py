...
F10=plt.figure(10)
plt.suptitle(r'Normirani histogrami porazdelitve časov izumrtja sistema za razlčne $dt$ ',fontsize=16)
#plt.title(r'$\beta_r=4,\ \beta_s=5,\ N_0=$'+str(N0)+', N='+str(N)+' ponovitev')#+'(N='+str(N)+',M='+str(M)+')')
...
plt.xlabel(r'$  t_{izumrtje} $',fontsize=18)
