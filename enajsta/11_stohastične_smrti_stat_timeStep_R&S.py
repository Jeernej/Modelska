...
plt.title(r'$\beta_r$=4, $\beta_s$=5, N='+str(N)+' ponovitev')#+'(N='+str(N)+',M='+str(M)+')')
...
#    dt=0.01
    ...
    #    N0=25
        ...
        while  Nt>0 :
            ...
            dNR=np.random.poisson(lam=4*beta*Nt*dt, size=None)
            dNS=np.random.poisson(lam=5*beta*Nt*dt, size=None)
