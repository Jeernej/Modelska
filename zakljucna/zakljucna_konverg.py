...
for i in range(0,n):
    ...
    fi_rand = np.random.normal(0, sirina)*pi*2
    ...
    if deltaE <= 0: 
        ...
        if abs(energ-wiki[N-2])<=0.001 and on==1:
            sirina=sirina/10
            on=2
            SIRINA=np.append(SIRINA, i+1)
            print('on='+str(on))

        if abs(energ-wiki[N-2])<=0.0001 and on==2:
            sirina=sirina/10
            on=3
            SIRINA=np.append(SIRINA, i+1)
            print('on='+str(on))

        if abs(energ-wiki[N-2])<=0.00001 and on==3:
            sirina=sirina/10
            on=4
            SIRINA=np.append(SIRINA, i+1)
            print('on='+str(on))

        if abs(energ-wiki[N-2])<=0.000001 and on==4:
            sirina=sirina/10
            on=5
            SIRINA=np.append(SIRINA, i+1)
...
Y_3=Y_3_0**2+Y_3_1**2+Y_3_2**2+Y_3_3**2
#+mY_3_1**2+mY_3_2**2+mY_3_3**2
...
Y_4=Y_4_0**2+Y_4_1**2+Y_4_2**2+Y_4_3**2+Y_4_4**2
#+mY_4_1**2+mY_4_2**2+mY_4_3**2+mY_4_4**2
...
Y_5=Y_5_0**2+Y_5_1**2+Y_5_2**2+Y_5_3**2+Y_5_4**2+Y_5_5**2
#+mY_5_1**2+mY_5_2**2+mY_5_3**2+mY_5_4**2+mY_5_5**2
...
Y_6=Y_6_0**2+Y_6_1**2+Y_6_2**2+Y_6_3**2+Y_6_4**2+Y_6_5**2+Y_6_6**2
#+mY_6_1**2+mY_6_2**2+mY_6_3**2+mY_6_4**2+mY_6_5**2+mY_6_6**2
...
plt.title(r'Potek energije in njenih  kvadratnih odmikov za '+str(k)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N))#+'(N='+str(N)+',M='+str(M)+')')
...
plt.title(r'Spremembe energije za vsako od k='+str(k)+r' sprejetih potez pri $N_e$='+str(N))#+'(N='+str(N)+',M='+str(M)+')')
...
plt.ylabel(r'R=k/i' ,fontsize=16)     
#plt.xscale('log')
#plt.yscale('log')
#plt.legend(loc='best',fontsize=16)
#plt.tight_layout()
...
plt.title(r'Potek težišča za '+str(k)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N))#+'(N='+str(N)+',M='+str(M)+')')
