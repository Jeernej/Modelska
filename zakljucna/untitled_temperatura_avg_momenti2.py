...
Sirina=np.array([sirina,sirina/2,sirina/5])#,sirina/10])
...
for s in Sirina:
    ...
    for t in TT:
        ...
        for i in range(0,n):
            ...
            th_rand = np.random.normal(0, sirina)*pi
            fi_rand = np.random.normal(0, sirina)*pi
    ...
    #    
        ...
        avg_E=np.append(avg_E,avgE[-1])
        avg_dE=np.append(avg_dE,avgdE[-1])
        avg_DE=np.append(avg_DE,avgDE[-1])
        ...
        Avg_EE_avgE2=np.append(Avg_EE_avgE2,avgEE_avgE2[-1])
        
        Avg_Y_0=np.append(Avg_Y_0,avg_Y_0[-1])
        Avg_Y_1=np.append(Avg_Y_1,avg_Y_1[-1])
        Avg_Y_2=np.append(Avg_Y_2,avg_Y_2[-1])
        Avg_Y_3=np.append(Avg_Y_3,avg_Y_3[-1])
        Avg_Y_4=np.append(Avg_Y_4,avg_Y_4[-1])
        Avg_Y_5=np.append(Avg_Y_5,avg_Y_5[-1])
        Avg_Y_6=np.append(Avg_Y_6,avg_Y_6[-1])
...
#    plt.yscale('log')
    ...
    plt.title(r'Temperaturne spremembe kvadratnih odmikov energije $\left< V_N^2 \right>-\left< V_N\right>^2$ za '+'{:.{}e}'.format(n, 0 )+r' potez pri $N_e$='+str(N))#+' in n='+str(n))#+'(N='+str(N)+',M='+str(M)+')')
    plt.plot(TT,Avg_EE_avgE2,color=crta[c], ls='-',marker='o',alpha = 0.95,label=r'$\sigma$='+'{:.{}f}'.format(sirina, 2))
    plt.plot(TT,Avg_EE_avgE2/TT,color=crta[c], ls=':',marker='o',alpha = 0.95,label=r'$\sigma$='+'{:.{}f}'.format(sirina, 2))
    #plt.axhline(y=wiki[N-2], color='k', linestyle='--',label=r'$V_N^{min}$='+str(wiki[N-2])+' ; (Vir [2])')
    #plt.axhline(y=np.mean(avg_E), color='r', linestyle=':',label=r'$\left< V_N^{min} \right>_{mean}$='+str(np.mean(avgE)))
    plt.xlabel(r'T' ,fontsize=16)   
    plt.ylabel(r'energija' ,fontsize=16)   
...
#    plt.yscale('log')
    ...
    plt.title(r'Temperaturne spremembe povprečja vsote kvadratov m-komponent momentov $\left<Y_l^m\right>$ za '+'{:.{}e}'.format(n, 0 )+r' potez pri $N_e$='+str(N))#+' in n='+str(n))#+'(N='+str(N)+',M='+str(M)+')')
    plt.plot(TT,Avg_Y_4,color=crta[c], ls='-',marker='o',alpha = 0.95,label=r'$\sigma$='+'{:.{}f}'.format(sirina, 2))
    plt.plot(TT,Avg_Y_5,color=crta[c], ls='--',marker='o',alpha = 0.95,label=r'$\sigma$='+'{:.{}f}'.format(sirina, 2))
    plt.plot(TT,Avg_Y_6,color=crta[c], ls=':',marker='o',alpha = 0.95,label=r'$\sigma$='+'{:.{}f}'.format(sirina, 2))
    #plt.axhline(y=wiki[N-2], color='k', linestyle='--',label=r'$V_N^{min}$='+str(wiki[N-2])+' ; (Vir [2])')
    #plt.axhline(y=np.mean(avg_E), color='r', linestyle=':',label=r'$\left< V_N^{min} \right>_{mean}$='+str(np.mean(avgE)))
    plt.xlabel(r'T' ,fontsize=16)   
    plt.ylabel(r'energija' ,fontsize=16)   
