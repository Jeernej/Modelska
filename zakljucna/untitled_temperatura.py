...
#for zz in range(1,6) :
TT=np.array([100,10,1,0.1,0.01,0.001,0.0001,0.00001])
T=10
temp =10**(1)
I=np.empty(0)
SIRINA=np.empty(0)
...
avg_avgEE_avgE2=Izrac_povprečja(avgEE-avgE2)


avgdE=Izrac_povprečja(abs(dE))
avgDE=Izrac_povprečja(abs(E-np.ones(k+l)*wiki[N-2]))
...
plt.ylabel('n')
#plt.legend(loc='best')
plt.title(r'porazdelitev $\phi$ korakov ',fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
...
plt.ylabel('n')
#plt.legend(loc='best')
plt.title(r'porazdelitev $\theta$ korakov ',fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
#plt.tight_layout()
...
#plt.plot(avg_Y_0,'k',alpha = 0.95,label=r'$\left<\sum_mY_{0m}^2\right>$='+'{:.{}e}'.format(avg_Y_0[0], 1 ))
#plt.plot(avg_Y_1,'r',alpha = 0.95,label=r'$\left<\sum_mY_{1m}^2\right>$='+'{:.{}e}'.format(avg_Y_1[0], 1 ))
#plt.plot(avg_Y_2,'b',alpha = 0.95,label=r'$\left<\sum_mY_{2m}^2\right>$='+'{:.{}e}'.format(avg_Y_2[0], 1 ))
#plt.plot(avg_Y_3,'g',alpha = 0.95,label=r'$\left<\sum_mY_{3m}^2\right>$='+'{:.{}e}'.format(avg_Y_3[0], 1 ))
#plt.plot(avg_Y_4,'y',alpha = 0.95,label=r'$\left<\sum_mY_{4m}^2\right>$='+'{:.{}e}'.format(avg_Y_4[0], 1 ))
#plt.plot(avg_Y_5,'m',alpha = 0.95,label=r'$\left<\sum_mY_{5m}^2\right>$='+'{:.{}e}'.format(avg_Y_5[0], 1 ))
#plt.plot(avg_Y_6,'c',alpha = 0.95,label=r'$\left<\sum_mY_{6m}^2\right>$='+'{:.{}e}'.format(avg_Y_6[0], 1 ))
...
plt.title(r'Potek energije in njenih  kvadratnih odmikov za '+str(k+l)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
...
plt.title(r'Spremembe energije za vsako od k+l='+str(k+l)+r' sprejetih potez pri $N_e$='+str(N),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
...
for i in I: 
    ...
    else: plt.axvline(x=i,color='k',alpha = 0.15)#+'{:.{}f}'.format(SHfi, 3 ))
...
plt.title(r'Potek težišča za '+str(k+l)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
plt.plot(TEZISC_x,'r:',alpha = 0.95,label=r'$x_T$='+'{:.{}e}'.format(TEZISC_x[-1], 1 ))
plt.plot(TEZISC_y,'g:',alpha = 0.95,label=r'$y_T$='+'{:.{}e}'.format(TEZISC_z[-1], 1 ))
plt.plot(TEZISC_z,'b:',alpha = 0.95,label=r'$z_T$='+'{:.{}e}'.format(TEZISC_y[-1], 1 ))
plt.axhline(y=0, color='k', linestyle='--')
...
#plt.legend(loc='best',fontsize=16)
##plt.tight_layout()
plt.title(r'Potek vsote kvadratov m-komponent momentov $\left<Y_l^m\right>$ za '+str(k+l)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N)+' in T='+str(temp),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
...
plt.title(r'Potek povprečja količin za '+str(k+l)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N)+' in T='+str(temp),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
plt.plot(avgE,'r',alpha = 0.95,label=r'$\left< V_N\right>_{reached}$='+'{:.{}f}'.format(avgE[-1], 9))
plt.axhline(y=wiki[N-2], color='k', linestyle='--',label=r'$V_N^{min}$='+str(wiki[N-2])+' ; (Vir [2])')
plt.axhline(y=np.mean(avgE), color='r', linestyle='--',label=r'$\left< V_N\right>_{mean}$='+str(np.mean(avgE)))
plt.plot(avg_avgEE_avgE2,'r:',alpha = 0.95,label=r'$\left<\left< V_N^2 \right>-\left< V_N\right>^2\right>$')
plt.xlabel(r'sprejete poteze' ,fontsize=18)   
plt.ylabel(r'$V_N^{min}$' ,fontsize=18)   
plt.yscale('log')
plt.legend(loc=4,fontsize=18)
#
F77=plt.subplot(2, 1, 2 )
plt.title(r'Potek povprečja spremembe energije za vsako od k+l='+str(k+l)+r' sprejetih potez pri $N_e$='+str(N)+' in T='+str(temp),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
plt.plot(avgdE,'b',alpha = 0.95,label=r' $\left< |dV_N| \right>_{reached}$='+'{:.{}e}'.format(avgdE[-1], 1 ))
...
F777=plt.figure(777)
plt.title(r'Potek povprečja vsote kvadratov m-komponent momentov $\left<Y_l^m\right>$ za '+str(k+l)+' sprejetih potez od '+'{:.{}e}'.format(n, 0 )+r' pri $N_e$='+str(N)+' in T='+str(temp),fontsize=18)#+'(N='+str(N)+',M='+str(M)+')')
plt.plot(avg_Y_0,'k',alpha = 0.95,label=r'$\left<\sum_mY_{0m}^2\right>$='+'{:.{}e}'.format(avg_Y_0[-1], 1 ))
plt.plot(avg_Y_1,'r',alpha = 0.95,label=r'$\left<\sum_mY_{1m}^2\right>$='+'{:.{}e}'.format(avg_Y_1[-1], 1 ))
plt.plot(avg_Y_2,'b',alpha = 0.95,label=r'$\left<\sum_mY_{2m}^2\right>$='+'{:.{}e}'.format(avg_Y_2[-1], 1 ))
plt.plot(avg_Y_3,'g',alpha = 0.95,label=r'$\left<\sum_mY_{3m}^2\right>$='+'{:.{}e}'.format(avg_Y_3[-1], 1 ))
