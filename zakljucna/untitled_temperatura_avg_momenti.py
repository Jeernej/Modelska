...
def Izrac_povprečja(vektor,frekv):     
    z=0
    M=0
    AVG=0
    for i in range(len(vektor)//5,len(vektor)): #začnem po burnin-u ; od 1/5 sprejetih potez dalje (za 10^4 izvedenih potez)
        
        if z==frekv : ## frekvenca zajemanja vrednosti npr. vsaka deseta poteza
            AVG=AVG+vektor[i] ## za povprečje vzamem vsako npr. 10-to 
            z=0
            M=M+1
...
N=7 ## !! popravi tudi zgoraj v zanki energija !!!
n=10**(4)  ### število izvedenih potez
fr=10 ## frekvenca zajemanja sprejetih potez za računanje povprečnih vrednosti
sirina=np.sqrt(8*pi/N/np.sqrt(3))
Sirina=np.array([sirina])#,sirina/2,sirina/10])#,sirina/10])
...
#for zz in range(1,6) :
TT=np.array([0.001,0.002,0.006,0.008,0.01,0.02,0.06,0.1,0.2,0.6,0.8,1,2,6,10])
#TT=np.empty(0)
#for t in range(1,21) :
#    TT=np.append(TT,0.5*t)
T=1
temp =10**(0)
I=np.empty(0)
SIRINA=np.empty(0)
...
#        TT=np.append(TT,temp)
    ...
    #    
        ...
        Y_7_0=Izrac_momenta(ZacetniAnim,7,0) 
        Y_7_1=Izrac_momenta(ZacetniAnim,7,1) 
        Y_7_2=Izrac_momenta(ZacetniAnim,7,2) 
        Y_7_3=Izrac_momenta(ZacetniAnim,7,3) 
        Y_7_4=Izrac_momenta(ZacetniAnim,7,4) 
        Y_7_5=Izrac_momenta(ZacetniAnim,7,5) 
        Y_7_6=Izrac_momenta(ZacetniAnim,7,6)
        Y_7_7=Izrac_momenta(ZacetniAnim,7,7)
        mY_7_1=Izrac_momenta(ZacetniAnim,7,-1) 
        mY_7_2=Izrac_momenta(ZacetniAnim,7,-2) 
        mY_7_3=Izrac_momenta(ZacetniAnim,7,-3) 
        mY_7_4=Izrac_momenta(ZacetniAnim,7,-4) 
        mY_7_5=Izrac_momenta(ZacetniAnim,7,-5) 
        mY_7_6=Izrac_momenta(ZacetniAnim,7,-6) 
        mY_7_7=Izrac_momenta(ZacetniAnim,7,-7) 
        Y_7=Y_7_0**2+Y_7_1**2+Y_7_2**2+Y_7_3**2+Y_7_4**2+Y_7_5**2+Y_7_6**2+Y_7_7**2    +mY_7_1**2+mY_7_2**2+mY_7_3**2+mY_7_4**2+mY_7_5**2+mY_7_6**2+mY_7_7**2


        Y_8_0=Izrac_momenta(ZacetniAnim,8,0) 
        Y_8_1=Izrac_momenta(ZacetniAnim,8,1) 
        Y_8_2=Izrac_momenta(ZacetniAnim,8,2) 
        Y_8_3=Izrac_momenta(ZacetniAnim,8,3) 
        Y_8_4=Izrac_momenta(ZacetniAnim,8,4) 
        Y_8_5=Izrac_momenta(ZacetniAnim,8,5) 
        Y_8_6=Izrac_momenta(ZacetniAnim,8,6)
        Y_8_7=Izrac_momenta(ZacetniAnim,8,7)
        Y_8_8=Izrac_momenta(ZacetniAnim,8,8)
        mY_8_1=Izrac_momenta(ZacetniAnim,8,-1) 
        mY_8_2=Izrac_momenta(ZacetniAnim,8,-2) 
        mY_8_3=Izrac_momenta(ZacetniAnim,8,-3) 
        mY_8_4=Izrac_momenta(ZacetniAnim,8,-4) 
        mY_8_5=Izrac_momenta(ZacetniAnim,8,-5) 
        mY_8_6=Izrac_momenta(ZacetniAnim,8,-6) 
        mY_8_7=Izrac_momenta(ZacetniAnim,8,-7) 
        mY_8_8=Izrac_momenta(ZacetniAnim,8,-8) 
        Y_8=Y_8_0**2+Y_8_1**2+Y_8_2**2+Y_8_3**2+Y_8_4**2+Y_8_5**2+Y_8_6**2+Y_8_7**2+Y_8_8**2    +mY_8_1**2+mY_8_2**2+mY_8_3**2+mY_8_4**2+mY_8_5**2+mY_8_6**2+mY_8_7**2+mY_8_8**2


        
#        #Izrac_povprečja(vektor)
#        avg_Y_0=np.mean(Y_0_0)
#        avg_Y_1=np.mean(Y_1)
#        avg_Y_2=np.mean(Y_2)
#        avg_Y_3=np.mean(Y_3)
#        avg_Y_4=np.mean(Y_4)
...
#        #Izrac_povprečja(vektor,fr)  
        avg_Y_0=Izrac_povprečja(Y_0_0,fr)
        avg_Y_1=Izrac_povprečja(Y_1,fr)
        avg_Y_2=Izrac_povprečja(Y_2,fr)
        avg_Y_3=Izrac_povprečja(Y_3,fr)
        avg_Y_4=Izrac_povprečja(Y_4,fr)
        avg_Y_5=Izrac_povprečja(Y_5,fr)
        avg_Y_6=Izrac_povprečja(Y_6,fr)
        avg_Y_7=Izrac_povprečja(Y_7,fr)
        avg_Y_8=Izrac_povprečja(Y_8,fr)
    
        avgE=Izrac_povprečja(E,fr)
        avgdE=Izrac_povprečja(abs(dE),fr)
        avgDE=Izrac_povprečja(abs(E-np.ones(k+l)*wiki[N-2]),fr)
        avgEE=Izrac_povprečja(E**2,fr)
        ...
        Avg_EE_avgE2=np.append(Avg_EE_avgE2,avgEE_avgE2)
        
        Avg_Y_0=np.append(Avg_Y_0,avg_Y_0)
        Avg_Y_1=np.append(Avg_Y_1,avg_Y_1)
        Avg_Y_2=np.append(Avg_Y_2,avg_Y_2)
        Avg_Y_3=np.append(Avg_Y_3,avg_Y_3)
        Avg_Y_4=np.append(Avg_Y_4,avg_Y_4)
        Avg_Y_5=np.append(Avg_Y_5,avg_Y_5)
        Avg_Y_6=np.append(Avg_Y_6,avg_Y_6)
        Avg_Y_7=np.append(Avg_Y_7,avg_Y_7)        
        Avg_Y_8=np.append(Avg_Y_8,avg_Y_8)
...
#    plt.yscale('log')
    ...
    print(np.shape(TT))
    print(np.shape(Avg_EE_avgE2))
    
    F7=plt.figure(7)
    F7=plt.subplot(2, 1, 1 )
    plt.title(r'Temperaturne spremembe kvadratnih odmikov energije za '+'{:.{}e}'.format(n, 0 )+r' potez pri $\sigma$='+'{:.{}f}'.format(sirina, 2)+' in $N_e$='+str(N))#+' in n='+str(n))#+'(N='+str(N)+',M='+str(M)+')')
    plt.plot(TT,Avg_EE_avgE2,color=crta[c], ls='-',marker='o',alpha = 0.95,label=r'$\left< V_N^2 \right>-\left< V_N\right>^2$')
    plt.plot(TT,Avg_EE_avgE2/(TT**2),color=crta[c], ls=':',marker='o',alpha = 0.95,label=r'$C_v=\left< V_N^2 \right>-\left< V_N\right>^2/k_B T^2$')
    #plt.axhline(y=wiki[N-2], color='k', linestyle='--',label=r'$V_N^{min}$='+str(wiki[N-2])+' ; (Vir [2])')
    #plt.axhline(y=np.mean(avg_E), color='r', linestyle=':',label=r'$\left< V_N^{min} \right>_{mean}$='+str(np.mean(avgE)))
    plt.xlabel(r'T' ,fontsize=16)   
#    plt.ylabel(r'energija' ,fontsize=16)   
    ...
    print(np.shape(Avg_Y_4))
    print(np.shape(Avg_Y_5))
    print(np.shape(Avg_Y_6))
    
    F7=plt.subplot(2, 1, 2)
    plt.title(r'Temperaturne spremembe povprečja vsote kvadratov m-komponent momentov $\left<Y_l^m\right>$ za '+'{:.{}e}'.format(n, 0 )+r' potez pri $\sigma$='+'{:.{}f}'.format(sirina, 2)+' in $N_e$='+str(N))#+' in n='+str(n))#+'(N='+str(N)+',M='+str(M)+')')
#    plt.plot(TT,Avg_Y_1,color=crta[2], ls='-',marker='o',alpha = 0.95,label=r'l=1, $\sigma$='+'{:.{}f}'.format(sirina, 2))
#    plt.plot(TT,Avg_Y_2,color=crta[2], ls='-',marker='o',alpha = 0.95,label=r'l=2, $\sigma$='+'{:.{}f}'.format(sirina, 2))
    plt.plot(TT,Avg_Y_3,color=crta[0], ls='-',marker='o',alpha = 0.95,label=r'l=3')
    plt.plot(TT,Avg_Y_4,color=crta[1], ls='-',marker='o',alpha = 0.95,label=r'l=4')
    plt.plot(TT,Avg_Y_5,color=crta[2], ls='-',marker='o',alpha = 0.95,label=r'l=5')
    plt.plot(TT,Avg_Y_6,color=crta[3], ls='-',marker='o',alpha = 0.95,label=r'l=6')
    plt.plot(TT,Avg_Y_7,color=crta[4], ls='-',marker='o',alpha = 0.95,label=r'l=7')
    plt.plot(TT,Avg_Y_8,color=crta[5], ls='-',marker='o',alpha = 0.95,label=r'l=8')
    #plt.axhline(y=wiki[N-2], color='k', linestyle='--',label=r'$V_N^{min}$='+str(wiki[N-2])+' ; (Vir [2])')
    #plt.axhline(y=np.mean(avg_E), color='r', linestyle=':',label=r'$\left< V_N^{min} \right>_{mean}$='+str(np.mean(avgE)))
    plt.xlabel(r'T' ,fontsize=16)   
#    plt.ylabel(r'energija' ,fontsize=16)   
